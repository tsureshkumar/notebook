...
;;(add-to-list 'load-path/ "~/notebook/emacs/site-lisp/cedet-1.1/contrib")
...
;(load-library "cedet-devel-load.el")
;(load-library "cedet-contrib-load.el")
;;(add-to-list 'load-path "~/projects/cedet-bzr/contrib/")
(add-to-list  'Info-directory-list "~/notebook/emacs/site-lisp/cedet-1.1/doc/info")
